 ...
 */
@WebServlet("/MostrarActD")
public class MostrarActD extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { 
        ...
        try {
			...
			if(MostrarMA!=null&&MostrarMA.equals("OK")) {
				String n,d,du,c,f;
				DtActDeportiva a=buscaractividad(actividad);
			...
			rd = request.getRequestDispatcher("/consultaActividadD.jsp");
