...
<html>
    <head>
        ...
        <title> Ranking actividades deportivas</title>
		<link rel="stylesheet" href="css/styleMenu.css"> 	<!-- css para la barra de MENU-->		
        <link rel="stylesheet" href="css/rankingActividadD.css"> <!-- css para CUERPO CENTRAL RESPONISVE-->
							  ...
							  <table>
					            ...
					            <tbody>
					             ...
					             <tr>
					                ...
					                <td data-label="COSTO"> <%=dta.getCosto()%> $</td>
					              </tr>
									<%
												i++; 
											}
					                ...
					                <td data-label="DESCRIPCION"> <li>Vacio</li> </td>
					                <td data-label="COSTO"> <li>Vacio</li> </td>
									</tr>
										<%
										}
					            	
					            	
					            	}else if (mostrar.equals("actD")) {
					            		DtActDeportiva dta = (DtActDeportiva) request.getAttribute("DtActDeportiva");%>
											<h1><%=dta.toString()%></h1><%
										}%>
					            </tbody>
					          </table>
